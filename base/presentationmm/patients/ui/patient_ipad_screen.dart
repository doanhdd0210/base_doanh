...
class PatientsIpadScreen extends StatefulWidget {
  const PatientsIpadScreen({super.key});

  @override
  State<PatientsIpadScreen> createState() => _PatientsIpadScreenState();
}

class _PatientsIpadScreenState extends State<PatientsIpadScreen> {
  double height = 32;
  final floatingSize = 48.w;
  final floatingMargin = 18.0.w;
  late double colWidth;

  @override
  void initState() {
    super.initState();
    colWidth = DeviceSingleton.instance.isIpad ? 100.w : 100.w;
  }
    ...
    return Positioned(
      ...
      child: Builder(builder: (context) {
        return FloatingActionButton(
          mini: !DeviceSingleton.instance.isIpad,
          onPressed: () async {
    ...
    return FittedBox(
      child: Column(
        children: [
          CountdownWidget(
            endTime: endTime,
            timeTextStyle: context.typography.caption
                  ...
                  child: ElevatedButton(
                    ...
                    style: context.style.primaryButton.copyWith(
                        backgroundColor: WidgetStatePropertyAll(
                            updateLogType.selectedTriageColor)),
                    child: Text(updateLogType.itemName,
                        style: TextStyle(
                            color: updateLogType.selectedTriageTextColor)),
                  ),
                ),
    );
  }
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: OutlinedButton(
          ...
          style: context.style.primaryOutlinedButton.copyWith(
  ...
  Widget _logo() {
    return SizedBox(
      height: context.read<AppCubit>().appBarHeight.h,
      child: Row(
        children: [
          Column(
            mainAxisSize: MainAxisSize.min,
